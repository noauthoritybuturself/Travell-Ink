...
class Image_CRUD {
    ...
    protected function _insert_table($file_name, $relation_id = null)
    {
    	$insert = array($this->url_field => $file_name);
    		$insert['category_id'] = '22';
    		$insert[$this->priority_field] = 'priority';
    ...
    {
    	$relation_value= '22';
    	$this->relation_field = 'category_id';
	...
	protected function getState()
	{
		...
		if(isset($rsegments_array[3]) && is_numeric($rsegments_array[3]))
		{
			...
			$state = array( 'name' => 'list', 'upload_url' => $upload_url, 'relation_value' => '22');
